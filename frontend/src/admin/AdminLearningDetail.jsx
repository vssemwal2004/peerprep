        ...
        <main className="flex-1 overflow-y-auto">
          {!sidebarOpen && (
            <button
              ...
              className="fixed left-[calc(var(--admin-sidebar-width)+1rem)] top-4 z-10 p-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:bg-gray-50 dark:hover:bg-gray-700"
            >

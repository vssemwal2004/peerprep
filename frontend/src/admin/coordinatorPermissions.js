    ...
    permissions: [
      {
        ...
        description: 'View coding-question health and activity inside the library.',
        accessType: 'View',
        usage: 'Shows Coding Overview inside Library.',
        routes: ['/coordinator/library/coding/overview', '/coordinator/compiler'],
      },
      {
        key: 'coordinator.compiler.create',
        name: 'Create Coding Problems',
        description: 'Author new coding problems from the question library.',
        accessType: 'Create',
        usage: 'Shows Create Coding Problem inside Library.',
        routes: ['/coordinator/library/coding/create', '/coordinator/compiler/create'],
      },
      {
        ...
        routes: ['/coordinator/library/coding/problems', '/coordinator/library/coding/:id/edit', '/coordinator/library/coding/:id/preview', '/coordinator/compiler/problems', '/coordinator/compiler/:id/edit', '/coordinator/compiler/:id/preview'],
      },
      {
        key: 'coordinator.compiler.analytics',
        name: 'Coding Analytics',
        description: 'View coding submission analytics and performance signals.',
        accessType: 'Analytics',
        usage: 'Shows Coding Analytics inside Library.',
        routes: ['/coordinator/library/coding/analytics', '/coordinator/compiler/analytics'],
      },
    ],
  },
  {

...
export const coordinatorPermissionCategories = [
  ...
  },
  {
    ...
    permissions: [
      ...
      {
        key: 'coordinator.students.create',
        name: 'Add and Import Students',
        description: 'Create individual students and validate or upload student CSV files.',
        accessType: 'Create',
        usage: 'Shows Add Student and enables student onboarding workflows.',
        routes: ['/coordinator/onboarding'],
      },
      {
        key: 'coordinator.students.manage',
        name: 'Manage Student Records',
        description: 'Edit, delete, organize upload lists, and resend credentials for accessible students.',
        accessType: 'Manage',
        usage: 'Enables write actions in the student database and bulk-list management.',
        routes: ['/coordinator/students', '/coordinator/students/bulk-lists'],
      },
      {
  ...
  },
  {
    ...
    permissions: [
      ...
      {
        key: 'coordinator.assessment.feedback',
        name: 'Assessment Feedback',
        description: 'Review feedback submitted for assessments.',
        accessType: 'Review',
        usage: 'Shows Assessment Feedback in coordinator navigation.',
        routes: ['/coordinator/assessment-feedback'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    permissions: [
      ...
      {
        key: 'coordinator.master-data.manage',
        name: 'Academic Master Data',
        description: 'Manage shared courses, branches, campuses, semesters, and academic values.',
        accessType: 'Manage',
        usage: 'Shows Master Data under Settings.',
        routes: ['/coordinator/settings/master-data', '/coordinator/settings/master-data/:category'],
      },
      {
        key: 'coordinator.email-templates.manage',
        name: 'Email Templates',
        description: 'Create and maintain platform email templates.',
        accessType: 'Manage',
        usage: 'Shows Email Templates under Settings.',
        routes: ['/coordinator/settings/email-templates'],
      },
      {
        key: 'coordinator.email-queue.manage',
        name: 'Email Queue',
        description: 'Review queued delivery jobs and retry failed email batches.',
        accessType: 'Manage',
        usage: 'Shows Email Queue under Settings.',
        routes: ['/coordinator/email-queue'],
      },
      {

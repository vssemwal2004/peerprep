    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className="flex min-h-screen">
        ...
        <button
          ...
          className="lg:hidden fixed top-4 z-40 p-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700"
        ...
        <div className={`activity-sidebar fixed lg:sticky top-0 h-screen w-64 bg-white dark:bg-gray-900 border-r border-slate-200 dark:border-gray-700 flex-shrink-0 overflow-y-auto z-40 transform transition-transform duration-300 ${mobileSidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`} style={{

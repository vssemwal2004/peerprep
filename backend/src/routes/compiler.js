...
import { getExpectedOutput, runCode, submitCode } from '../controllers/compilerController.js';
import {
...
router.post('/run', requireStudent, compilerExecutionLimiter, runCode);
router.post('/submit', requireStudent, compilerExecutionLimiter, submitCode);
